...
def login(request):
    ...
    # redirects user to dashboard in case of manual 'login' url input
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    # getting the produxt variation by cart id
                    product_variation = []
...
def forgotPassword(request):
    ...
    if request.method == 'POST':
        ...
        if Account.objects.filter(email=email).exists():
            ...
            current_site = get_current_site(request)
            mail_subject = "Password recovery request"
...
def resetPassword(request):
    ...
    try:
        ...
        messages.error(request, 'The link is expired! Please start again.')
        return redirect('forgotPassword')
        ...
        if new_password == confirm_password:
            ...
            if success:
                if new_password == current_password:
                    messages.error(request, 'New password has to be different to the old one!')
